    ...
    async with TelegramClient(
        ...
        while True:
            ...
            for msg in saved_messages:
                print(f"Сообщение {msg.id}, grouped_id: {msg.grouped_id}, имеет медиа: {bool(msg.media)}")
                if msg.grouped_id:
                ...
                # Пересылаем альбомы
            print(f"⚡ Группировка завершена. Всего альбомов: {len(albums)}, сообщений без медиа: {len(individual_messages)}")
